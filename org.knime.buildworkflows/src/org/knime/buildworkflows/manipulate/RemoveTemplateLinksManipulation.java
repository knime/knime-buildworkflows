 ...
 * @since 4.5
 */
public class RemoveTemplateLinksManipulation extends WorkflowSegmentManipulation {
    @Override
    public void apply(final WorkflowSegment workflowSegment) throws Exception {
        ...
        linkedMetaNodes.entrySet().stream().filter(entry -> {
            ...
            return MetaNodeTemplateInformation.Role.Link.equals(templateInformation.getRole());
        }).forEach(entry -> {

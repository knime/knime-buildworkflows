 ...
 */
final class WorkflowSummaryExtractorNodeDialog extends DefaultNodeSettingsPane {

    private static final StringIconOption[] OPTIONS =
        {new DefaultStringIconOption(WorkflowSummaryExtractorNodeModel.FMT_SELECTION_JSON, JSONCell.TYPE.getIcon()),
            new DefaultStringIconOption(WorkflowSummaryExtractorNodeModel.FMT_SELECTION_XML, XMLCell.TYPE.getIcon()),};
